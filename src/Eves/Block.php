...
abstract class Block extends Xua
{
    ...
    final public function __get(string $halfName)
    {
        ...
        if ($signature === null) {
            throw (new MagicCallException())->setError($halfName, ExpressionService::getXua('eves.block.error_message.unknown_signature_name', ['signatureName' => static::class . '::' . $halfName]));
        }
